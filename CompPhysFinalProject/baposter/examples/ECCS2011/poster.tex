...
\headerbox{General Mechanism}{name=problem,column=0,row=0}{
The principle of a cellular automata is to have an evolving lattice of cells, with values of either 0 or 1, in which the evolution of every cell is dependent on the value 
